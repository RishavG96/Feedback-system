   ...
   <nav class="navbar navbar navbar-fixed-top" style="height: 50px">
    ...
    <div class="container">
        <div id="mySidenav" class="sidenav" style="width:25%; margin-top: 50px; padding: 0;">
            ...
            <a class="btn " disabled href="#" style="background-color: #A11913;height: 90px">WORK AND LIFE<br> BALANCE</a>
            <a class="btn " disabled href="#" style="background-color: #861510; height: 90px; padding-top: 20px;" >PROGRESS</a>
            <a class="btn " disabled href="#" style="background-color: #FF8A65; height: 90px; padding-top: 20px;">CHALLENGES</a>
        </div>
        ...
        <div style="margin-top : 5%;">
            ...
            <form class="form-group formwidth" method="post" action="page5-script.php">
                ...
                <input type="text" name="q2" style="width:500px; height: 100px; padding: 0; color: black"><br><br>
