...
<body style="background-color: #CF4747">
    ...
    <?php
        ...
        // Form the SQL query that returns the top 10 most populous countries
     	$strQuery18 = "SELECT q2 FROM workbal";
        $query18 = "SELECT q2 from workbal";
    ...
    <?php
        ...
        // Form the SQL query that returns the top 10 most populous countries
     	$strQuery20 = "SELECT q3 FROM workbal ";
        $query20 = "SELECT q3 from workbal";
    ...
    <?php
        ...
        // Form the SQL query that returns the top 10 most populous countries
     	$strQuery26 = "SELECT * FROM workbal";
        $query26 = "SELECT * from workbal";
