   ...
   <nav class="navbar navbar navbar-fixed-top" style="height: 50px">
    ...
    <div class="container">
        <div id="mySidenav" class="sidenav" style="width:25%; margin-top: 50px; padding: 0;">
            <a href="page2.php" class="btn active" style="background-color: #C21E17; height: 90px" >GUIDANCE<br> RECEIVED</a>
            <a class="btn " disabled href="#" style="background-color: #C21E17; height: 90px">FACILITIES <br>AVAILABLE</a>
            <a class="btn " disabled href="#" style="background-color: #FF8A65 ;height: 90px">WORK AND LIFE<br> BALANCE</a>
            <a class="btn " disabled href="#" style="background-color: #861510; height: 90px; padding-top: 20px;" >PROGRESS</a>
            <a class="btn " disabled href="#" style="background-color: #670F0B; height: 90px; padding-top: 20px;">CHALLENGES</a>
        </div>
                ...
                <table class="table table-bordered table-hover">
                    <tbody>
                        <tr>
                            ...
                            <td style="color: black;"><select style="width : 200px;" name="q1">
                    ...
                    <option value="Poor" class="form-control">Poor</option>
                        ...
                        <tr>
                            ...
                            <td style="color: black;"><select style="width : 200px;" name="q2">
                    ...
                    <option value="More than 80 hours" class="form-control">More than 80 hours</option>
                        ...
                        <tr>
                            ...
                            <td style="color: black;"><select style="width : 200px;" name="q3">
